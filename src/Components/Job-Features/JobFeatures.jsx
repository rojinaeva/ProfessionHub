...
const JobFeatures = (props) => {
    const {logo,job_position,company_name,job_type,job_site,job_location,salary_range}=props.job;
    return (
        <div className='p-4 border border-white rounded-xl'>
           ...
           <button className='bg-zinc-400 px-3 py-3 rounded-xl font-extrabold text-white text-xl hover:bg-zinc-500 mt-6'>View Details</button>
